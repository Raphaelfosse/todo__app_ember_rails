...
define('todo-app/tests/lint/app.lint-test', [], function () {
  'use strict';
...
define('todo-app/tests/lint/templates.template.lint-test', [], function () {
  'use strict';

  QUnit.module('TemplateLint');

  QUnit.test('todo-app/templates/application.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'todo-app/templates/application.hbs should pass TemplateLint.\n\n');
  });

  QUnit.test('todo-app/templates/todos.hbs', function (assert) {
    assert.expect(1);
    assert.ok(true, 'todo-app/templates/todos.hbs should pass TemplateLint.\n\n');
  });
});
...
define('todo-app/tests/test-helper', ['todo-app/app', 'todo-app/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
define('todo-app/tests/unit/adapters/application-test', ['qunit', 'ember-qunit'], function (_qunit, _emberQunit) {
  'use strict';
